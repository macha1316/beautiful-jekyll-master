...
subtitle: "意味・例文・類義語をWordnik APIでまとめて取得する"
description: "Wordnik APIを使って英単語の定義、例文、類義語、発音情報を取得する方法をTypeScript例つきで解説します。"
cover-img: /assets/img/header.webp
thumbnail-img: /assets/img/2025-06-29/wordnik.webp
share-img: /assets/img/2025-06-29/wordnik.webp
tags: [API]
category: errlog
author: taiyou
---
...
<img src="/assets/img/2025-06-29/wordnik1.webp" alt="ノート作成" style="max-width: 300px;" />
<img src="/assets/img/2025-06-29/wordnik2.webp" alt="ノート作成" style="max-width: 300px;" />
